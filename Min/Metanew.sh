...
# script by Mr.white from (Technical Helper) youtube channel
apt-get update -y
apt-get upgrade -y
...
git clone https://github.com/did4510/bcp
...
echo "          If You Are Connected To Internet Then 
        you have downloaded metasploit successfully. 
          Subscribe us on youtube (Technical Helper)"
echo " "
...
(((G   |-----|
  ...
  /______)   (_____\' | lolcat
echo " "
echo "Type msfconsole to start ./msfconsole...or wait lazy boy...."
echo " "
sleep 8.0
clear
echo ""
