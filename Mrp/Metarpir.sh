...
' | lolcat
echo " "
echo -e "$red       Metasploit Repairing Process Has Been Started...$rset"
echo "  "
echo -e "$grn        [This May Take TiMe UpTo 30 MiNuTeS sO wAiT]$rset" 
echo "red                 starting Metasploit-framework....$rset "
cd $HOME
...
echo 
echo -e "$grn        [This May Take Time Up-to 30 Minutes so wait]$rset"
echo
cd $HOME/m-fire/min
sleep 8.0
clear
